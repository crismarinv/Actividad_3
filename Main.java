...
public class Main {
    ...
    private static void registrarSalida(Parqueadero parqueadero, Scanner scanner) {
        ...
        parqueadero.registrarSalida(placa, horaSalidaStr);
    }
    ...
    private static void consultarEstado(Parqueadero parqueadero) {
        ...
        if (vehiculos.isEmpty()) {
            ...
            for (Vehiculo vehiculo : vehiculos) {
                System.out.println(vehiculo.getPlaca() + " - " + vehiculo.getMarca() + " " + vehiculo.getModelo() + " - Combustible:" + vehiculo.getTipoCombustible());
            }
        }
    }
}